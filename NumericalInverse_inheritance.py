...
class InverseSimulation(Simulation):  # later abbreviated as Prob
    ...
    def evaluate_window_error_norm(self) -> float:
        """
    ...
    def evaluate_one_inverse_step(self) -> None:
        """
        ...
        q_adj = self.init_q_adjustment  # initial adjustments to heat flux being currently solved
